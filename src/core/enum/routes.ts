export const ROUTES = {
  ...
  RELATORIO_AEE_REGISTRO_ITINERANCIA_IMPRESSAO:
    "/relatorios/aee/registro-itinerancia",
  RELATORIO_CONTROLE_FREQUENCIA_MENSAL:
    "/relatorios/frequencia/controle-mensal",
  AUTENTICACAO_INTEGRACOES_FREQUENCIA:
    "/autenticacao/integracoes/frequencia/:tokenIntegracaoFrequencia",
  ...
  BUSCA_ATIVA_CONSULTA_CRIANCAS_ESTUDANTES_AUSENTES:
    "/busca-ativa/criancas-estudantes/ausentes",
  BUSCA_ATIVA_HISTORICO_REGISTRO_ACOES:
    "/busca-ativa/criancas-estudantes/ausentes/historico-registro-acoes",
  BUSCA_ATIVA_HISTORICO_REGISTRO_ACOES_NOVO:
    "/busca-ativa/criancas-estudantes/ausentes/historico-registro-acoes/novo",
  BUSCA_ATIVA_HISTORICO_REGISTRO_ACOES_EDICAO:
    "/busca-ativa/criancas-estudantes/ausentes/historico-registro-acoes/:id",
  ...
  RELATORIO_MAPEAMENTO_ESTUDANTES:
    "/relatorios/diario-classe/mapeamento-estudantes",
