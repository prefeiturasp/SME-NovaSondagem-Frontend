...
interface SelectColoridoProps extends SelectProps {
  // Parâmetros removidos - lógica de cores agora vem do backend
  // tipoQuestao?:
  //   | "escrita"
  //   | "reescrita"
  //   | "producao"
...
const SelectColorido: React.FC<SelectColoridoProps> = ({
  ...
  const getColorByValue = useCallback(
    (selectedValue: any): { bg: string; text: string } => {
      ...
      // Usava switch/case para definir arrays de cores baseado em tipoQuestao e anoTurma
      ...
      // ===== LÓGICA NOVA =====
      // Busca as cores diretamente dos dados vindos da API/Mock
      // Cada opção já contém corFundo e corTexto
